...
public class ServiceTaskLogger {
    ...
    public static File initializeAndGetResultsFile(String fileNamePrefix) throws IOException {
        ...
        FileUtils.write(resultsFile, EMPTY_STRING, StandardCharsets.UTF_8);
     ...
     * @param processedData processed data objects
     * @throws IOException in case of an I/O error
     */
    ...
    public static void updateResultsFile(File file, List<?> processedData) throws IOException {
        var accountInfoToFile = processedData.toString();
        FileUtils.write(file, accountInfoToFile, StandardCharsets.UTF_8);
    ...
    public static void logResults(File resultsFile) throws IOException {
        ...
        Allure.step(logMessage);
        Allure.addAttachment(resultsFile.getName(), "application/json",
                FileUtils.readFileToString(resultsFile, StandardCharsets.UTF_8));
        LOGGER.info(logMessage);
    }
}
