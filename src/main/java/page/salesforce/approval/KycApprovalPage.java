...
import page.components.LightningDatepicker;
import page.salesforce.approval.modal.KycDetailsAttachmentsModal;
import com.codeborne.selenide.SelenideElement;
import com.sforce.soap.enterprise.sobject.Approval__c;

import static page.salesforce.approval.ApprovalHistoryRelatedListPage.APPROVE_BUTTON_LABEL;
...
public class KycApprovalPage extends ApprovalPage {
    ...
    public static final String NEED_TO_ATTACH_PARTICIPATION_AGREEMENT_ERROR = "You need to attach the copy of signed-off " +
            "participation agreement and select sign off date to approve the request";
    ...
    public final SelenideElement gstStateCodeOfCustomerOutput =
            detailsSection.$x(".//*[div/span='GST State Code of Customer']//*[@data-output-element-id='output-field']");
    ...
    /**
     * Approve KYC approval via "Approval History" related list.
     * Works for both negative and positive cases.
     */
    public void approveApproval() {
        openRelatedList(APPROVAL_HISTORY_RELATED_LIST);
        approvalHistoryRelatedListPage.clickListViewPageButton(APPROVE_BUTTON_LABEL);
        approvalHistoryRelatedListPage.approvalModal.commentInput
                .shouldBe(visible, ofSeconds(10))
                .setValue(TEST_STRING);
        approvalHistoryRelatedListPage.approvalModal.approveButton.click();
    }
}
