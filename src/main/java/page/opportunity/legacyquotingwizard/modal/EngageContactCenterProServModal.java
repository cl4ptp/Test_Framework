package page.opportunity.legacyquotingwizard.modal;
...
/**
 * Modal window in {@link LegacyQuotingWizardPage} (Quote Wizard, "Contact Center" tab)
...
public class EngageContactCenterProServModal {
    ...
    public final SelenideElement additionalDetailsInput = dialogContainer.$("[name='comment']");
