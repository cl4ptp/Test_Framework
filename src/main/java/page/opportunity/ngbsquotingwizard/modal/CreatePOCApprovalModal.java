...
public class CreatePOCApprovalModal {
    ...
    public static final String HEADER = "Create POC Approval";
    public static final String LABEL = "Link to signed Evaluation Agreement";
    public static final String INPUT_REQUIRED_ERROR_TEXT = "This field is required";
