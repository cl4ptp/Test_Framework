...
public class CartItem {
    ...
    private final By promoIcon = byCssSelector("[icon='price_book_entries'] icon");
    ...
    public ElementsCollection getDiscountTypeSelectOptions() {
        return cartItemElement.$(discountTypeSelect).$$("option");
    }
    ...
    private Integer getLevel(SelenideElement cartItem) {
        return Integer.valueOf(
                cartItem.getAttribute("data-ui-auto-cart-item-nesting-level")
        );
    }
}
