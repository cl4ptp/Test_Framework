...
import page.opportunity.ngbsquotingwizard.carttab.AreaCodePage;
import page.opportunity.ngbsquotingwizard.carttab.DeviceAssignmentPage;
 ...
 * <p></p>
 * Can be found on {@link NGBSOpportunityCreationPage}, {@link LeadConvertPage}, {@link DeviceAssignmentPage},
...
public class AreaCodeSelector {
    ...
    private final By areaCodeNameText = byCssSelector("icon[iconname='custom64'] ~ span");
    ...
    /**
     * Return text element of the current Area Code Selector.
     * <p></p>
     * Useful for checks of full selected area code text.
     *
     * @return the current Area Code Selector text element
     */
    public SelenideElement getAreaCodeTextElement() {
        return areaCodeComponent.$(areaCodeNameText);
    }
    ...
    public AreaCodeSelector waitUntilEnabled() {
        ...
        getInputElement().shouldHave(attribute(
                "placeholder", START_TYPING_TO_SEARCH_MESSAGE),
                ofSeconds(90)
        );
    ...
    public void selectCode(AreaCode areaCode) {
        ...
        areaCode.fullName = getAreaCodeTextElement().getText();
    }
