...
public class CustomLwcLookupComponent extends AbstractLookupComponent {
    ...
    public SelenideElement getSelectedEntity() {
        return searchInputComponentElement.$x(".//div/a");
    }
    ...
    public void selectItemInCombobox(String searchQuery, String searchedItemName) {
        ...
        */
        var searchQueryGrowing = new StringBuilder();
        for (int i = 0; i < searchQuery.length(); i++) {
            var querySingleChar = String.valueOf(searchQuery.charAt(i));
            searchQueryGrowing.append(querySingleChar);
            getInput().setValue(searchQueryGrowing.toString());
