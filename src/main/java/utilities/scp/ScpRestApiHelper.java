...
import static utilities.Constants.BASE_ENV_NAME;
...
public class ScpRestApiHelper {
    ...
    public static final String SCP_REST_ENDPOINT_UAT = "http://arm01-t01-awu01.lab.nordigy.ru:8080";
    public static final String SCP_REST_ENDPOINT_STAGING = "http://bis03-p01-awu01.lab.nordigy.ru:8080";
     ...
     *
     * @return base URL for other services (e.g. "http://arm01-t01-awu01.lab.nordigy.ru:8080")
     */
    public static String getBaseScpRestApiUrl() {
        ...
        if (BASE_ENV_NAME != null && !BASE_ENV_NAME.isBlank()) {
            switch (BASE_ENV_NAME) {
                default:
                case "ARM-BI-AMS":
                    return SCP_REST_ENDPOINT_UAT;
                case "BIS-UAT-SV7":
                    return SCP_REST_ENDPOINT_STAGING;
                case "BI-QA-SV7":
