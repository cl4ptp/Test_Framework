package utilities.scp;

import model.scp.ScpOperationRequestDTO;
import model.scp.ScpOperationRequestDTO.Variables;
import model.scp.ScpOperationRequestDTO.Variables.TesterFlagsItem;
import model.scp.ScpOperationResponseDTO;
import utilities.RestApiClient;
import io.qameta.allure.Step;

import static model.scp.ScpOperationRequestDTO.ACCOUNT_INFO_OPERATION;
import static model.scp.ScpOperationRequestDTO.CHANGE_TESTER_FLAGS_OPERATION;
import static model.scp.ScpOperationRequestDTO.Variables.TesterFlagsItem.*;
import static utilities.RestApiAuthentication.usingApiKey;
import static utilities.scp.ScpRestApiHelper.*;
