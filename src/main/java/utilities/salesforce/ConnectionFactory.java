...
public class ConnectionFactory {
    /**
     * Current version of Salesforce API.
     * Note: needs to be updated for every update of the Connection Libraries.
     */
    private final static String API_VERSION = "53.0";
    ...
    public static EnterpriseConnection getEnterpriseConnection(SalesforceConfig config) throws ConnectionException {
        var authEndpoint = String.format(ENDPOINT_SOAP, config.serverUrl, API_VERSION);
