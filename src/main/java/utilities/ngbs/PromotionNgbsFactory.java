...
import model.ngbs.testdata.PromotionDiscountTemplate;

import static model.ngbs.dto.discounts.DiscountNgbsDTO.DiscountValue.getDiscountValueForSerialization;
import static model.ngbs.dto.discounts.PromotionNgbsDTO.PromoAvailability.AvailableType.PACKAGE;
import static model.ngbs.dto.discounts.PromotionNgbsDTO.PromoAvailability.AvailableType.PRODUCT;
...
public class PromotionNgbsFactory {
    ...
    private static DiscountNgbsDTO.DiscountTemplate createDiscountTemplateForPromotion(PromotionDiscountTemplate promoDiscountData,
        ...
        var discountValueTemplate =
                getDiscountValueForSerialization(promoDiscountData.type, promoDiscountData.value);
