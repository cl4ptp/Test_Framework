...
import static model.ngbs.dto.discounts.DiscountNgbsDTO.ApplicableTo.ApplicableType.CATALOG_ID;
...
public class DiscountNgbsFactory {
    ...
    public DiscountNgbsDTO createDiscountTemplateGroup(
        ...
        discountTemplate.description = format("%d %s off to %s='%s' (QA Auto)",
