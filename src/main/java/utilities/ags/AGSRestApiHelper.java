...
public class AGSRestApiHelper {
    ...
    private static final String BASE_URL_UAT = "http://arm01-t01-ags01.lab.nordigy.ru:8081";
    private static final String BASE_URL_STAGING = "http://bis03-p01-ags01.lab.nordigy.ru:8081";
     ...
     *
     * @return base URL for other services (e.g. "http://arm01-t01-jws01.lab.nordigy.ru/")
     */
     ...
     *
     * @param scenario special scenario for account generation (e.g. "office.paid(18,1)").
