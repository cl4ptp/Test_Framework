...
import model.ags.JobResultInfoDTO;
...
import static utilities.ags.AGSRestApiHelper.*;
...
public class AGSRestApiClient {
    ...
    private static final long JOB_STATUS_TIMEOUT = 120_000L;
     ...
     *                 <p> E.g. <b>"office.paid(18,1,dlCount=30)"</b> for: </p>
     *                 <p> - RingCentral MVP Standard package (packageID = 18, version = 1) </p>
    ...
    public static AccountAgsDTO createAccount(String scenario) {
        long jobId = generateNewAccount(scenario);
