package model.ngbs.dto.discounts;

import model.ngbs.testdata.Promotion;
import utilities.ngbs.NGBSRestApiClient;
import utilities.ngbs.PromotionNgbsFactory;
 ...
 * to/fro NGBS API discount service (see {@link NGBSRestApiClient} for a reference).
 * <br/><br/>
...
public class PromotionNgbsDTO extends DiscountNgbsDTO {
    ...
    public PromotionNgbsDTO(Promotion promotionTestData) {
        name = promotionTestData.promoCode;
        promoCode = promotionTestData.promoCode;
        description = promotionTestData.description;
        startDate = Clock.systemUTC().instant().toString();
        priority = "Z";

        var sfdcDirectLabel = new Labels();
        sfdcDirectLabel.accessLabel = new PromoLabels.AccessLabels[]{PromoLabels.AccessLabels.SFDC_DIRECT};
        labels = sfdcDirectLabel;

        promoType = new PromoCodeType(1);
    }
    ...
    public static class PromoAvailability {
     ...
     */
    @JsonInclude(value = NON_NULL)
    public static class PromoLabels {
     ...
     */
    @JsonInclude(value = NON_NULL)
    public static class PromoCodeType {
