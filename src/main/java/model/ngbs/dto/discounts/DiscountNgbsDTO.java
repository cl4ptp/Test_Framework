...
public class DiscountNgbsDTO extends DataModel {
     ...
     */
    @JsonInclude(value = NON_NULL)
    public static class DiscountTemplate {
        //  For 'valueTerm'
     ...
     */
    @JsonInclude(value = NON_NULL)
    public static class ApplicationTerm {
        ...
        public void setLicenseScope(String type) {
            this.licenseScope = type.equals(ApplicableTo.ApplicableType.LICENSE_ID.typeValue) ?
                    SCOPE_EXACT :
                    SCOPE_ALL;
        }
    }
    ...
    public static class DiscountValue {
         ...
         */
        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        public DiscountValue(@JsonProperty("unit") String unit, @JsonProperty("value") Integer value) {
            this.unit = unit;
            this.value = value;
        }
         ...
         */
        public static DiscountValue getDiscountValueForSerialization(String unit, Integer value) {
